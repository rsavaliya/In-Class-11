...
int main()
{
    ...
    cout << "First we will test to make sure the tree is completely empty right now." << endl;
    cout << "If this shows 00 it means that the tree is empty: " << test->is_word_in_tree("y") << test->is_word_in_tree("r") << endl;
    cout << "Now to test is both the functions work correctly." << endl;
    test->add_word_to_tree("yyyyy");
    cout << "If both functions worked correctly, you should see a 1: " << test->is_word_in_tree("yyyyy") << endl;
    cout << "Just to double check you should now see a 0 (adding yyyyr): " << test->is_word_in_tree("yyyyr") << endl;
    cout << "Now we will add yyyyr and test to see if the adding function works." << endl;
    test->add_word_to_tree("yyyyr");
    cout << "If this is a 1 then the function works correctly: " << test->is_word_in_tree("yyyyr") << endl;
    cout << "Now we will try to add yyyyy again and see to make sure nothing happens" << endl;
    cout << "This should return a 1: " << test->add_word_to_tree("yyyyy") << endl;
